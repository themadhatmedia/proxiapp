...
class EditCoreValuesScreen extends StatefulWidget {
  const EditCoreValuesScreen({super.key});

  @override
  State<EditCoreValuesScreen> createState() => _EditCoreValuesScreenState();
}

class _EditCoreValuesScreenState extends State<EditCoreValuesScreen> {
  ...
  Future<void> _handleSave() async {
    ...
    final success = await controller.saveCoreValues();
                      ...
                      Obx(() {
                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Obx(() {
                              final isSelected = controller.selectedCoreValueNames.contains(coreValue.name);
                              return GestureDetector(
